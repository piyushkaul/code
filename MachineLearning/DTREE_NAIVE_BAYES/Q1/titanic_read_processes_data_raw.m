...
% Apr 2016
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [traindata, medStruct] = titanic_read_processes_data_raw(filename, mode, medStruct)
fid = fopen(filename);
...
m = itr - 1;
if strcmp(mode,'train') && ~strcmp(mode,'raw')
...
for idx =1:m
    ...
    if ~strcmp(mode,'raw')
        ...
        traindata(idx,4) = cell2mat(traindataraw(idx,4));
        traindata(idx,5) = cell2mat(traindataraw(idx,5));
        traindata(idx,6) = cell2mat(traindataraw(idx,6));
        traindata(idx,7) = cell2mat(traindataraw(idx,7));
        traindata(idx,8) = cell2mat(traindataraw(idx,8));
    end 
    ...
    if ~strcmp(mode,'raw')
        ...
        traindata(idx,11) = cell2mat(traindataraw(idx,11));
    end
